...
class Actor(pygame.sprite.Sprite):
    ...
    @staticmethod
    def mouse(mouse_info):
        print('morse_info', mouse_info)

    @staticmethod
    def direction(direction_info):
        print('direc_info', direction_info)

    @staticmethod
    def control(control_info):
        print('cntro_info', control_info)